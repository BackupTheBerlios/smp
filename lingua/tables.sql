...
INSERT INTO lingua_dictionary (dict_id, en, de, fr) VALUES 
	(2001 , 'Only Unicode-file (.txt) admit!','Nur Unicode-Textdateiein (txt) sind zugelasen!', 'Seuls les fichiers Unicode (.txt) sont autorises!');
INSERT INTO lingua_dictionary (dict_id, en, de, fr) VALUES 
...
INSERT INTO lingua_dictionary (dict_id, en, de, fr) VALUES 
	(2016, 'for another description in another language or new Text use follow buttons', 'für weitere Beschreibung in andere Sprache oder neuer Text benutzen Sie die unteren Buttons.', 'Pour autre description en autres langues ou nouveaux textes utiliser les boutons ci-dessous');

##### Text_eingeben.tmpl (2017 -> 2036) ### (2026 & 2027 werden auch von Text_beschreibung.tmpl benutzt.) ######################################
INSERT INTO lingua_dictionary (dict_id, en, de, fr) VALUES 
...
INSERT INTO lingua_dictionary (dict_id, en, de, fr) VALUES 
	(2036, 'for another description of the text in another language use follow buttons', 'für neue Beschreibung des Textes in andere Sprache benutzen Sie die unteren Buttons.', 'Pour autre description du texte dans une nouvelle langue utiliser les boutons ci-dessous');
